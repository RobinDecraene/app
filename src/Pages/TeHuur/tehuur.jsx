...
import style from './tehuur.module.css';
import TeHuurDetail from '../../Components/Detail/TeHuur/tehuur.detail';
...
const TeHuur = () => {
  ...
  return (
    <section className={style.tehuur}>
    <div className={style.filter}>
      ...
      <div className={style.prijs}>
        ...
        <input className={style.inputTehuur} type="number" name="min" id="min" />

        <label htmlFor="max">Max</label>
        <input className={style.inputTehuur} type="number" name="max" id="max" />
      </div>
      
      <div className={style.slaapkamers}> 
        <h2>Slaapkamers</h2>
        <label htmlFor="minKamer">Min</label>
        <input className={style.inputTehuur} type="number" name="minKamer" id="minKamer" />

        <label htmlFor="maxKamer">Max</label>
        <input className={style.inputTehuur} type="number" name="maxKamer" id="maxKamer" />
      </div>

    </div>

    <div>
        <TeHuurDetail selectedSoortPanden={selectedSoortPanden} sortOrder={sortOrder}/>
    </div>
